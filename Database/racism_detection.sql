...
--
-- Host: localhost
-- Generation Time: Jan 24, 2023 at 10:48 AM
...
--
-- Database: `racism_detection`
--
CREATE DATABASE IF NOT EXISTS `racism_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `racism_detection`;
...
(1, 'Arvind', 'Arvind123@gmail.com', 'Arvind', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijayanagar\r\n', 'Male'),
...
(9, 'Extra Tree Classifier', '59.07155025553663'),
(10, 'SVM', '72.61499148211243'),
(11, 'Logistic Regression', '73.59454855195912'),
(12, 'KNeighborsClassifier', '59.45485519591141'),
(13, 'Random Forest Classifier', '71.37989778534923');
...
(22, 'Neutral', '28.57142857142857'),
(23, 'Racism', '42.857142857142854'),
(24, 'Positive', '14.285714285714285'),
(25, 'Negative', '14.285714285714285');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_sentiment_analysis_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_sentiment_analysis_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
