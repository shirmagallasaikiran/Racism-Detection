...
from Remote_User.models import ClientRegister_Model,sentiment_analysis_type,detection_ratio,detection_accuracy
...
def View_Prediction_Of_Sentiment_Analysis_Ratio(request):
    detection_ratio.objects.all().delete()
    ratio = ""
    kword = 'Neutral'
    print(kword)
    obj = sentiment_analysis_type.objects.all().filter(Q(Prediction=kword))
    obj1 = sentiment_analysis_type.objects.all()
    count = obj.count();
    count1 = obj1.count();
    ...
    kword1 = 'Racism'
    print(kword1)
    obj1 = sentiment_analysis_type.objects.all().filter(Q(Prediction=kword1))
    obj11 = sentiment_analysis_type.objects.all()
    count1 = obj1.count();
    count11 = obj11.count();
    ...
    kword12 = 'Positive'
    print(kword12)
    obj12 = sentiment_analysis_type.objects.all().filter(Q(Prediction=kword12))
    obj112 = sentiment_analysis_type.objects.all()
    count12 = obj12.count();
    ...
    kword123 = 'Negative'
    print(kword123)
    obj123 = sentiment_analysis_type.objects.all().filter(Q(Prediction=kword123))
    obj1123 = sentiment_analysis_type.objects.all()
    ...
    return render(request, 'SProvider/View_Prediction_Of_Sentiment_Analysis_Ratio.html', {'objs': obj})
...
def View_Prediction_Of_Sentiment_Analysis(request):
    obj =sentiment_analysis_type.objects.all()
    return render(request, 'SProvider/View_Prediction_Of_Sentiment_Analysis.html', {'list_objects': obj})
