"""racism_detection URL Configuration
...
from racism_detection import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Sentiment_Analysis/$', remoteuser.Predict_Sentiment_Analysis, name="Predict_Sentiment_Analysis"),
    ...
    url(r'^View_Prediction_Of_Sentiment_Analysis_Ratio/$', serviceprovider.View_Prediction_Of_Sentiment_Analysis_Ratio, name="View_Prediction_Of_Sentiment_Analysis_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Sentiment_Analysis/$', serviceprovider.View_Prediction_Of_Sentiment_Analysis, name="View_Prediction_Of_Sentiment_Analysis"),
